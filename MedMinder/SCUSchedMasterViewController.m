//
//  SCUSchedMasterViewController.m
//  MedMinder
//
...
@implementation SCUSchedMasterViewController
...
//    self.navigationItem.leftBarButtonItem = self.editButtonItem;
    ...
    {
        UIBarButtonItem *addButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemSave target:self action:@selector(saveBtn)];
    self.navigationItem.rightBarButtonItem = addButton;
    }
    ...
    if (self.detailItem) {
        ...
        self.managedObjectContext= prescription.managedObjectContext;
    }
}
...
- (void)insertNewObject:(id)sender
{
    ...
    [newManagedObject setValue:@"Time of Day" forKey:@"timeOfDay"];
